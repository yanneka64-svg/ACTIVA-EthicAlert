...
export const TRANSLATIONS: Record<Language, Record<string, string>> = {
  fr: {
    ...
    btn_edit_report: 'Modifier le rapport d’investigation',
    report_modal_title: 'Rapport d’investigation',
    report_modal_desc: 'Un rapport est requis avant de pouvoir envoyer le dossier en revue.',
  ...
  en: {
    ...
    btn_edit_report: 'Edit investigation report',
    report_modal_title: 'Investigation report',
    report_modal_desc: 'A report is required before the case can be sent for review.',
  ...
  pt: {
    ...
    btn_edit_report: 'Editar o relatório de investigação',
    report_modal_title: 'Relatório de investigação',
    report_modal_desc: 'É necessário um relatório antes de enviar o processo para revisão.',
