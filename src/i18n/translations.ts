...
export const TRANSLATIONS: Record<Language, Record<string, string>> = {
  fr: {
    ...
    label_enter_number: 'Numéro de dossier (ex: AARDC-26-09-0001)',
    ...
    email_status_title: 'État des notifications e-mail',
    email_status_empty: 'Aucune tentative d’envoi enregistrée pour le moment (nouveau signalement, attribution, escalade ou repli de routage).',
    email_status_summary: '{total} tentative(s) au total — {sent} réussie(s), {failed} échouée(s).',
    email_status_never_worked: 'Aucun e-mail n’est encore réellement parti dans cet environnement — l’envoi requiert le déploiement de la fonction serveur dédiée avec une clé API (voir {doc}). Chaque tentative reste honnêtement journalisée ci-dessus et dans l’Audit Trail — jamais un faux succès affiché.',
    email_status_partial_failure: 'Certains envois échouent — voir l’Audit Trail (entrées « Échec de l’envoi… ») pour le détail de chaque erreur.',
    // === AMÉLIORATION AJOUTÉE (réinitialisation de l'historique de test) ===
    email_status_clear: 'Réinitialiser',
    email_status_clear_confirm: 'Confirmer',
    email_status_clear_cancel: 'Annuler',
  ...
  en: {
    ...
    label_enter_number: 'Tracking number (e.g., AARDC-26-09-0001)',
    ...
    email_status_title: 'Email notification status',
    email_status_empty: 'No delivery attempt recorded yet (new report, assignment, escalation, or routing fallback).',
    email_status_summary: '{total} attempt(s) in total — {sent} succeeded, {failed} failed.',
    email_status_never_worked: 'No email has actually gone out in this environment yet — real delivery requires deploying the dedicated server function with an API key (see {doc}). Every attempt is still honestly logged above and in the Audit Trail — never a false success.',
    email_status_partial_failure: 'Some deliveries are failing — see the Audit Trail (entries starting with "Failed to send…") for each error’s detail.',
    email_status_clear: 'Reset',
    email_status_clear_confirm: 'Confirm',
    email_status_clear_cancel: 'Cancel',
  ...
  pt: {
    ...
    label_enter_number: 'Número de processo (ex: AARDC-26-09-0001)',
    ...
    email_status_title: 'Estado das notificações por e-mail',
    email_status_empty: 'Nenhuma tentativa de envio registrada até o momento (novo relato, atribuição, escalonamento ou repasse de roteamento).',
    email_status_summary: '{total} tentativa(s) no total — {sent} bem-sucedida(s), {failed} com falha.',
    email_status_never_worked: 'Nenhum e-mail foi realmente enviado neste ambiente até agora — o envio real requer a implantação da função de servidor dedicada com uma chave de API (ver {doc}). Cada tentativa continua sendo registrada honestamente acima e na Trilha de Auditoria — nunca um falso sucesso.',
    email_status_partial_failure: 'Alguns envios estão falhando — veja a Trilha de Auditoria (entradas "Falha no envio…") para o detalhe de cada erro.',
    email_status_clear: 'Redefinir',
    email_status_clear_confirm: 'Confirmar',
    email_status_clear_cancel: 'Cancelar',
